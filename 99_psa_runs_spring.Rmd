...
* Three populations with different degree of interactions among them
  ...
  + Staff and faculty
* We assume that students living on campus have a higher risk than those living off campus (R0 = 3.5 and 2.5 respectively).  Staff/faculty can be infected by students and can infect other staff/faculty, but we only track infections among staff/faculty acquired from others in the campus community. 
...
* The model runs from the day classes start (Aug 26) to the end of term (Dec 19)
